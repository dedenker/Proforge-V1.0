 ...
 */
   ...
   */
  #define MACHINE_NAME "Proforge Makertech 3D"
   ...
   * Marlin repository.
   */
  #define SOURCE_CODE_URL "https://github.com/MakertechDownloads/Proforge-V1.0"
   ...
   */
  #define WEBSITE_URL "https://www.makertech-3d.com"
